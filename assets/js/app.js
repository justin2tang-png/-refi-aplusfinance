  ...
  var i18n = {
    ...
    translations: {
      ...
      step3_title: "Savings Hit Your Account",
        ...
        faq_3_q: "How much can I save by refinancing?",
        faq_4_q: "How long does the process take?",
        faq_5_q: "Do I need a deposit to refinance?",
        faq_6_q: "What income do I need to qualify?",
        hero_desc: "Mortgage rates have changed. If you haven\u2019t reviewed your home loan in the last 12 months, you could be overpaying by thousands. Get a free, no-obligation refinance check today.",
        pain_1_desc: "Your variable rate has gone up twice this year, but your bank hasn\u2019t offered you a better deal.",
        pain_2_desc: "You hear about friends locking in lower rates and getting cashback \u2014 and wonder why you\u2019re not.",
        pain_3_desc: "The -500 you could save each month would make a real difference to your lifestyle or savings.",
        sol_1_desc: "Switch to a competitive rate from one of 10+ lenders we work with across NZ.",
        sol_2_desc: "Many banks offer ,000\u2013,000 cashback when you refinance with them.",
        sol_3_desc: "Restructure your loan to suit your current situation \u2014 offset, revolving credit, or fixed.",
        about_p1: "With 14 years at ANZ and now running A Plus Finance independently, Becky brings institutional knowledge and personal dedication to every client.",
        about_p2: "She specialises in home loan refinancing, helping homeowners across New Zealand find better rates, unlock equity, and structure their mortgages for life\u2019s next stage.",
        about_p3: "Becky\u2019s approach is straightforward: no jargon, no pressure, just clear advice that puts you first.",
        about_stat1: "Years in NZ Banking",
        about_stat2: "Years at ANZ",
        about_stat3: "Loans Advised",
        step1_desc: "Jump into our quick chat \u2014 answer 6 simple questions. It takes about 2 minutes.",
        step2_desc: "We review your situation and compare options from 10+ lenders to find the best fit.",
        step3_desc: "Once you choose the best option, we handle the paperwork. You start saving immediately.",
        ...
        testimonials_placeholder: "Real client stories coming soon.",
        faq_1_ans: "There are some costs involved: break fees on your current loan, valuation fees (~-800), and solicitor fees (~-1,200). The good news is that many banks offer cashback of ,000-4,000 that often covers these costs \u2014 so it can be cost-neutral or even profitable to switch.",
        faq_2_ans: "A credit check is part of the application process, which may have a small temporary impact. However, in New Zealand, multiple credit enquiries within a 30-day window count as a single check, so shopping around won\u2019t hurt your score.",
        faq_3_ans: "This depends on your loan amount and the rate difference. A typical saving is -500 per month on a ,000 loan with a 0.5-1% rate drop. Use our calculator above for a personalised estimate.",
        faq_4_ans: "Most refinances are completed within 2-3 weeks from your initial application. The process is mostly online, and we handle the coordination between banks and solicitors.",
        faq_5_ans: "No deposit is needed. Refinancing uses your existing home equity. You generally need at least 20% equity in your home, though some lenders may accept less depending on your situation.",
        faq_6_ans: "Lenders assess your ability to service the loan at a test rate (usually 1.5-2% above the actual rate). Each lender has different criteria, and we can help match you with the right one based on your income and expenses.",
        form_name: "Full Name",
        form_email: "Email",
        form_phone: "Phone",
        ...
        form_select: "Select...",
        form_message: "Anything else you\u2019d like Becky to know?",
        form_employment_placeholder: "Employment Type",
